...
# The p-value for the F statistic is < 2.2e-16 which is highly significant so at least one of the predictor variables is relevant to predicting ViolentCrimes.
```
